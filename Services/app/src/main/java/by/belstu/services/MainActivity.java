...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_start, btn_stop, btn_next;
    private TextView coord_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_stop = (Button)findViewById(R.id.stopSutton);
        btn_next = (Button)findViewById(R.id.nextButton);
        coord_text = (TextView)findViewById(R.id.coordText);
